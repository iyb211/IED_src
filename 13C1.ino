...
#define _POS_END _DUTY_MAX // for servo speed 3
// #define _POS_END _DUTY_NEU // for servo speed 0.3

#define _SERVO_SPEED 3 // servo speed limit (unit: degree/second)
#define INTERVAL 100  // servo update interval for servo speed 3
// #define INTERVAL 1000  // servo update interval for servo speed 0.3
